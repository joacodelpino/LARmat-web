        ...
        <div className="flex flex-wrap justify-center gap-4 sm:gap-5">
          {categories.map((cat, i) => {
            ...
            return (
              <div
                key={cat.title}
                className={`relative rounded-sm overflow-hidden cursor-pointer shadow-md transition-all duration-300 w-[calc(50%-8px)] md:w-[calc(33.333%-14px)] xl:w-[calc(16.666%-17px)] ${
